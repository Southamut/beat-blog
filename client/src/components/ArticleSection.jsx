...
import { BlogCard, ArticleButton, LoadingSpinner } from '@/components/ui/BlogCard';
        ...
        <section className="mx-auto w-full py-8 bg-brown-100">
            ...
            <div className="md:px-16">
                ...
                <div className="pb-4 md:pb-8">
                    <h2 className="text-2xl font-bold text-beown-600 text-left px-4 md:px-0">Latest articles</h2>
                </div>
                ...
                <div className="md:hidden px-4 py-4 bg-brown-200">
                    ...
                    <div className="md:hidden w-full mt-4">
                        <label className="text-brown-400 text-sm font-medium mb-2 block">Category</label>
                        <Select
                    ...
                    <div className="hidden md:flex space-x-2 h-12">
                        {categories.map((category) => (
                            <ArticleButton
                                ...
                                className={`hover:bg-brown-300 ${selectedCategory === category ? 'bg-brown-300' : ''}`}
                            />
                        ))}
                    </div>
                    {/* Search bar */}
